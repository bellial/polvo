...
function custom_excerpt( $length = 130 ) {
...
function enqueue_custom_styles() {
    ...
    // Construct the paths to your images relative to the uploads directory
    $economica_path = $uploads_dir['baseurl'] . '/2023/08/economica-scaled.jpg';
    $tecnologica_path = $uploads_dir['baseurl'] . '/2023/08/tecnologica-scaled.jpg';
    $educativa_path = $uploads_dir['baseurl'] . '/2023/08/mandala_educacional_shutterstock_2112109130-scaled.jpg';
    $emocional_path = $uploads_dir['baseurl'] . '/2023/08/mandala_emocional_shutterstock_1986605999-scaled.jpg';
    $alimentar_path = $uploads_dir['baseurl'] . '/2023/08/mandala_alimentar_shutterstock_2127480059-scaled.jpg';
    $habitacional_path = $uploads_dir['baseurl'] . '/2023/08/mandala_habitacional_shutterstock_462908386-scaled.jpg';
    $ambiental_path = $uploads_dir['baseurl'] . '/2023/08/ambiental.jpg';
    // Check if the website is loaded over HTTPS, and update the paths accordingly
    if (is_ssl()) {
        $economica_path = str_replace('http://', 'https://', $economica_path);
        $tecnologica_path = str_replace('http://', 'https://', $tecnologica_path);
        $educativa_path = str_replace('http://', 'https://', $educativa_path);
        $emocional_path = str_replace('http://', 'https://', $emocional_path);
        $alimentar_path = str_replace('http://', 'https://', $alimentar_path);
        $habitacional_path = str_replace('http://', 'https://', $habitacional_path);
        $ambiental_path = str_replace('http://', 'https://', $ambiental_path);
    }

    // Enqueue the styles
    wp_enqueue_style('preload-economica', $economica_path, array(), null, 'all');
    wp_enqueue_style('preload-tecnologica', $tecnologica_path, array(), null, 'all');
    wp_enqueue_style('preload-educativa', $educativa_path, array(), null, 'all');
    wp_enqueue_style('preload-emocional', $emocional_path, array(), null, 'all');
    wp_enqueue_style('preload-alimentar', $alimentar_path, array(), null, 'all');
    wp_enqueue_style('preload-habitacional', $habitacional_path, array(), null, 'all');
    wp_enqueue_style('preload-ambiental', $ambiental_path, array(), null, 'all');
