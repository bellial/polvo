...
/*
	parte vaza no mobile
	*/
	p.objetivos-txt {
    display: contents;
}

/*Tirando botoes embaixo do banner*/
.controles.container{
	display:none;
}
.slick-arrow-up.position-absolute{
	display:none;
}
/*Tirando botoes embaixo do banner*/
/*Tirando todo o banner da parte de cima*/
.carousel-wrapper{
		display:none;
	}
/*Tirando todo o banner da parte de cima*/
@media (max-width: 767px){
	.objetivos-wrapper.hovered.obj-1 {
		HEIGHT: 1400PX;
				...
				<div class="carousel-slick-inner">
				  ...
				  <div class="carousel-slick-item position-relative <?php if($j == 0) echo 'active';?>">
					<section class="position-absolute carousel-text text-white"><?php echo wpautop($texto); ?></section>
					  <img class="teste" src="<?php echo $image; ?>" class="d-block w-100" alt="...">
					</a>
				  </div><!--carousel-item-->
				<?php   
				...
				<section class="row row-cols-2 objetivos-row justify-content-center align-items-center text-white">
					<div class="col objetivos-blur d-flex flex-column align-items-start justify-content-between text-start p-3" data-target="obj-1">
						<div>
							...
							<p class="objetivos-txt">Assegurar incremento de renda digno e sustentável para as famílias apicultoras.</p>
					</div>
					<div class="col objetivos-blur d-flex flex-column align-items-start justify-content-between text-start p-3" data-target="obj-2">
						<div>
							...
							<p class="objetivos-txt">Garantir segurança hídrica com água potável para as 41 comunidades apicultoras.</p>
					</div>
					<div class="col objetivos-blur d-flex flex-column align-items-start justify-content-between text-start p-3" data-target="obj-3">
						<div>
							...
							<div>
								<p class="objetivos-txt">Garantir a melhoria educacional e cognitiva dos apicultores adultos.</p>
								<p class="objetivos-txt">Fomentar o empreendedorismo dos jovens para incentivar a apicultura local.</p>
								<p class="objetivos-txt">Garantir a alfabetização na primeira infância para apoiar a mobilidade social dos apicultores da região.</p>
							</div>
					</div>
					<div class="col objetivos-blur d-flex flex-column align-items-start justify-content-between text-start p-3" data-target="obj-4">
						<div>
							...
							<p class="objetivos-txt">A apicultura, que já é uma atividade de baixo carbono, ajuda na polinização e na regeneração da mata nativa.</p>
					</div>
				</section>
			</section>
		</section>
...
<!--NOVA ABA-->
	...
	<?php
		echo do_shortcode('[elementor-template id=484]');
	?>
...
-->
	...
	<section class="text-center azul-padrao cinzinha">
		...
		<?php
		echo do_shortcode('[elementor-template id=487]');
	?>
